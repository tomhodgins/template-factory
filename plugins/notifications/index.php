...
<pre><code class=javascript>notification(message,theme,duration)</code></pre>
...
<pre><code class=javascript>notification()</code></pre>
...
<pre><code class=javascript>notification('This is custom notification text')</code></pre>
...
<pre><code class=javascript>notification('Custom text',10)</code></pre>
...
<pre><code class=javascript>notification('Settings Saved!',5,'success')
notification('A Case Number is Required',0,'error')
notification('Please resolve conflicts before proceeding',0,'warning')</code></pre>
